...
const ChatPage = () => {
  ...
  const [showChatList, setShowChatList] = useState(!location.state?.chatId);
  ...
  const getProfileImageUrl = (user) => {
    ...
    return `http://localhost:5000/uploads/${user.profileImage.replace(
      "/uploads/",
      ""
    )}`;
  };
  ...
  // Update chat selection to handle mobile view
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 h-[calc(100vh-160px)]">
              ...
              <div
                ...
                } md:col-span-1 border-r border-[#D1E7D2]/50 max-h-full overflow-hidden flex flex-col bg-white/50 rounded-l-2xl`}
              >
                <div className="p-4 border-b border-[#D1E7D2] bg-white/80 backdrop-blur-sm">
                  <h2 className="text-xl font-semibold text-[#3B4540]">
                    Messages
                  </h2>
                </div>
                    ...
                    chats.map((chat) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-medium text-[#3B4540]">
              ...
              <div
                className={`${
                  isMobile ? (!showChatList ? "block" : "hidden") : "block"
                } md:col-span-2 flex flex-col max-h-full overflow-hidden bg-white/80 rounded-r-2xl`}
              >
                {selectedChat ? (
                  <>
                    <div className="p-4 border-b border-[#D1E7D2] bg-white/90 backdrop-blur-sm">
                      <div className="flex items-center gap-3">
                        ...
                        {(() => {
                          const otherParty =
                            selectedChat.customerId._id === user._id
                            ...
                            {filePreview && filePreview !== "document" ? (
                              ...
                              <div className="p-2 bg-gray-100 rounded-lg inline-flex items-center gap-2">
                                ...
                                >
                                  <path
                                    fillRule="evenodd"
                                    d="M4 3a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z"
                                    clipRule="evenodd"
                                  />
                                </svg>
                                {file.name}
                  ...
                  >
                    <div className="text-center">
                      <svg
                        className="w-16 h-16 mx-auto text-[#98cf9a] mb-4"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
