...
const SellerListingCard = ({ listing, onListingUpdate }) => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case "Active":
        return "bg-[#438951] text-white";
      case "Pending":
        return "bg-[#FFA500] text-white";
      case "Sold":
        return "bg-[#4A644E] text-white";
      default:
        return "bg-[#438951] text-white";
    }
  };
  ...
  return (
    <>
      <div className="group bg-white rounded-xl shadow-md overflow-hidden transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
        ...
        {/* Content */}
        <div className="p-5">
          <h3 className="text-lg font-semibold text-[#3B4540] mb-2 truncate">
            {listing.title}
          </h3>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <select
                ...
                className={`px-3 py-1 rounded-full text-sm font-medium shadow-md cursor-pointer ${getStatusColor(
                  listing.status
                )}`}
              >
...
export default React.memo(SellerListingCard);
